...
export default function NewAppointment() {
  ...
  console.log({ routineVaccines, mapped })
          ...
          <div className="grid grid-cols-2 gap-4 px-8 py-5">
            ...
            <div className="py-4 block">
                {categoryVaccines.map((vaccine) => (
                  <span class="block my-2 flex justify-between gap-x-3 py-2 ps-5 pe-2 rounded-full font-medium bg-gray-100 mx-2">
                    {vaccine.vaccineName}
                    
                    <button
                      type="button"
                      class="flex-shrink-0 size-4 mr-2 mt-1 inline-flex rounded-full">
                      <span class="sr-only">Remove badge</span>
                      <svg class="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="red" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                    </button>
                  </span>
                ))}
              </div>
            ...
            <Row className='mt-5 px-6' gutter={16}>
              ...
              <Col className='gutter-row' span={12}>
                <Form.Item
                  ...
                  <DatePicker className='w-full rounded-md border-0 py-2.5 text-sm text-[#707070] ring-1 ring-inset ring-[#4E4E4E] placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#163C94]' />
                </Form.Item>
              </Col>
              ...
              <Col className='gutter-row' span={12}>
                <Form.Item
                  ...
                  <DatePicker className='w-full rounded-md border-0 py-2.5 text-sm text-[#707070] ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#163C94]' />
                </Form.Item>
              </Col>
